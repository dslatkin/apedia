	  ...
	  <TABLE WIDTH="470" CELLSPACING="0" CELLPADDING="5">
		  <TR> 
            <TD VALIGN="TOP" BGCOLOR="#CCCCCC"> <p><strong>Current known items 
              ...
              <p>Hey all,</p>
              <p>Talonz here, dropping in after what, 16 years since the last update?
              If you're a former Whispers in Akarra player or a bit curious
              about this game, you should check out the following projects
              and communities working to keep active servers running that people
              can still play:
              <ul>
                <li>
              ...
              <p>
                Additionally, you can always check out <a href="https://akarra.com">akarra.com</a>
                for even more news and information. The venerable Luna keeps it running.
                If you'd like to get your site, server, or project added to this list,
                I'm sure you can manage to find me on one of those Discord servers. ;)
              </p>
              <p>Until next time...</p>
    ...
    <TD WIDTH="200" ALIGN="CENTER" VALIGN="TOP" BGCOLOR="CCFFCC">
	  ...
	  <TABLE WIDTH="200" align="center" CELLSPACING="0">
		<TR>
          ...
          <?
          $images = [
                '<a href="images/pics/large/berdiche.jpg" target="_blank"><img src="images/pics/thumbnail/berdiche.jpg" alt="A Berdiche" width="140" height="223" border="0"></a>',
                '<a href="images/pics/large/claymore.jpg" target="_blank"><img src="images/pics/thumbnail/claymore.jpg" alt="A Claymore" width="167" height="168" border="0"></a>',
                '<a href="images/pics/large/falchion.gif" target="_blank"><img src="images/pics/thumbnail/falchion.gif" alt="A Falchion (rotating)" width="65" height="171" border="0"></a>',
                '<a href="images/pics/large/flamberge.jpg" target="_blank"><img src="images/pics/thumbnail/flamberge.jpg" alt="A Flamberge" width="122" height="211" border="0"></a>',
                '<a href="images/pics/large/gladius.jpg" target="_blank"><img src="images/pics/thumbnail/gladius.jpg" alt="A Silver Gladius" width="130" height="190" border="0"></a>',
                '<a href="images/pics/large/khyber.jpg" target="_blank"><img src="images/pics/thumbnail/khyber.jpg" alt="A Khyber" width="135" height="160" border="0"></a>',
                '<a href="images/pics/large/rapier.jpg" target="_blank"><img src="images/pics/thumbnail/rapier.jpg" alt="A Rapier" width="108" height="170" border="0"></a>',
                '<a href="images/pics/large/rapierparts.jpg" target="_blank"><img src="images/pics/thumbnail/rapierparts.jpg" alt="A Rapier Diagram" width="169" height="115" border="0"></a>',
                '<a href="images/pics/large/stiletto.jpg" target="_blank"><img src="images/pics/thumbnail/stiletto.jpg" alt="A Stiletto" width="175" height="128" border="0"></a>',
                '<a href="images/pics/large/tegha.jpg" target="_blank"><img src="images/pics/thumbnail/tegha.jpg" alt="A Tegha" width="71" height="179" border="0"></a>',
              ];
          echo($images[array_rand($images)]);
          ?>
		  <? include("scripts/randex.php"); ?>
		  </P>
		  </DIV>
		  </TD>
  		</TR> 
...
<!-- Gostats.com web hit code. Please do not change this-->
    <SCRIPT>var go_mem="Akarra";</SCRIPT>
    <SCRIPT SRC="http://gostats.com/go.js"></SCRIPT>
    <NOSCRIPT>
    <A HREF="http://gostats.com/gogi/viewstats.pl?mn=Akarra" TARGET="_top"> 
    <IMG ALIGN="TOP" SRC="http://gostats.com/gogi/count.pl?mn=Akarra" BORDER="0"></A> 
    </NOSCRIPT>
    <!-- End of Gostats.com web hit code --><BR>
	<STRONG>since November 18, 2002</STRONG></DIV>
