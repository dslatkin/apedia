...
var hBar = new ItemStyle(99, 0, '', 0, 3, '#CCCCDD', '#6699CC', 'lowText', 'highText', '', '',
 null, null, 'hand', 'default');

var subM = new ItemStyle(22, 0, '&gt;', -15, 3, '#CCCCDD', '#6699CC', 'lowText', 'highText',
 'itemBorder', 'itemBorder', null, null, 'hand', 'pointer');

var subBlank = new ItemStyle(22, 0, '&gt;', -15, 3, '#CCCCDD', '#6699CC', 'lowText', 'highText',
 'itemBorder', 'itemBorder', null, null, 'hand', 'default');

var button = new ItemStyle(22, 1, '&gt;', -15, 2, '#CCCCDD', '#6699CC', 'buttonText', 'buttonHover',
...
pMenu.onclick = function(mN, iN) { with (this)
{
 if (mN == 'mGuides')
 {
  if (iN == 4) location.href = '/commands.htm';
  if (iN == 9) location.href = '/skillspell.htm';
  if (iN == 10) location.href = '/monsters.htm';
 }
 if (mN == 'mEquipment')
 {
  if (iN == 1) location.href = '/weapons.htm';
  if (iN == 2) location.href = '/armor.htm';
  if (iN == 3) location.href = '/accessories.htm';
  if (iN == 4) location.href = '/items.htm';
  if (iN == 5) location.href = '/scrolls.htm';
...
startMenu('root', false, 106, 98, 19, hBar);

addItem('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; News', 'mNews', 'sm:');
addItem('&nbsp;&nbsp; Screenshots', 'mScreenshots', 'sm:');
addItem('&nbsp;&nbsp;&nbsp; Downloads', 'mDownloads', 'sm:');
addItem('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Guides', 'mGuides', 'sm:');
addItem('&nbsp;&nbsp;&nbsp; Equipment', 'mEquipment', 'sm:');
addItem('&nbsp;&nbsp;&nbsp; Community', 'mCommunity', 'sm:');
addItem('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Contact', 'mContact', 'sm:');

// ***SUB MENUS***

startMenu('mNews', true, -1, 19, 100, subM);
addItem('Current News', '/', '');
addItem('News Archives', '/oldnews.htm', '');

startMenu('mScreenshots', true, 0, 19, 99, subM);
addItem('PreAlpha', 'mPreAlpha', 'sm:');
addItem('Alpha', 'mAlpha', 'sm:');

startMenu('mDownloads', true, 0, 19, 110, subM);
addItem('Download Game', '/downloads.htm#game', '');
addItem('Public Area Editor', '/downloads.htm#editor', '');

startMenu('mGuides', true, 0, 19, 130, subM);
addItem('Getting Started', '/getstarted.htm', '');
addItem('Character Classes', '/classes.htm', '');
addItem('Teamplay', '/teamplay.htm', '');
addItem('Fellowships', '/fellowships.htm', '');
addItem('Commands', 'mCommands', 'sm:');
addItem('Technical Info', '/technical.htm', '');
addItem('NPC Locations', '/npcs.htm', '');
addItem('Dungeon Locations', '/dungeons.htm', '');
addItem('Obelisk Locations', '/obelisks.htm', '');
addItem('Monsters', 'mMonsters', 'sm:');

startMenu('mEquipment', true, 0, 19, 99, subM);
addItem('Weapons', 'mWeapons', 'sm:');
addItem('Armor', 'mArmor', 'sm:');
addItem('Accessories', 'mAccessories', 'sm:');
addItem('Items', 'mItems', 'sm:');
addItem('Scrolls', 'mScrolls', 'sm:');

startMenu('mCommunity', true, 0, 19, 99, subM);
addItem('Forums', 'http://forums.akarra.com/', '');
addItem('Fansites', '/fansites.htm', '');
addItem('Guilds &amp; Clans', '/guildsclans.htm', '');

startMenu('mContact', true, 0, 19, 99, subM);
addItem('Contact Me', '/contact.htm', '');
addItem('Special Thanks', '/thanks.htm', '');

// ***SUB SUB MENUS***

startMenu('mPreAlpha', true, 98, 0, 85, subBlank);
addItem('PreAlpha 13', '/archives/screenshots/pa_13/screenshots.htm', '');

startMenu('mAlpha', true, 98, 0, 85, subBlank);
addItem('Alpha 1', '/screenshots.htm', '');

startMenu('mCommands', true, 129, 0, 85, subBlank);
addItem('General', '/commands.htm#general', '');
addItem('Fellowship', '/commands.htm#fellowship', '');
addItem('Guild', '/commands.htm#guild', '');
addItem('Shortcuts', '/commands.htm#shortcuts', '');

startMenu('mMonsters', true, 129, 0, 100, subBlank);
addItem('Levels 0 - 24', '/monsters.htm#0-24', '');
addItem('Levels 25 - 49', '/monsters.htm#25-49', '');
addItem('Levels 50 - 74', '/monsters.htm#50-74', '');
addItem('Levels 75+', '/monsters.htm#75-99', '');

startMenu('mWeapons', true, 98, 0, 85, subBlank);
addItem('Axes', '/weapons.htm#axes', '');
addItem('Crushing', '/weapons.htm#crushing', '');
addItem('Daggers', '/weapons.htm#daggers', '');
addItem('Non-Violent', '/weapons.htm#non-violent', '');
addItem('Ranged', '/weapons.htm#ranged', '');
addItem('Spears', '/weapons.htm#spears', '');
addItem('Staffs', '/weapons.htm#staffs', '');
addItem('Swords', '/weapons.htm#swords', '');

startMenu('mArmor', true, 98, 0, 85, subBlank);
addItem('Head', '/armor.htm#head', '');
addItem('Body', '/armor.htm#body', '');
addItem('Hands', '/armor.htm#hands', '');
addItem('Shields', '/armor.htm#shields', '');
addItem('Feet', '/armor.htm#feet', '');

startMenu('mAccessories', true, 98, 0, 85, subBlank);
addItem('Necklaces', '/accessories.htm#necklaces', '');
addItem('Rings', '/accessories.htm#rings', '');

startMenu('mItems', true, 98, 0, 85, subBlank);
addItem('Ammo', '/items.htm#ammo', '');
addItem('Food', '/items.htm#food', '');
addItem('Household', '/items.htm#household', '');
addItem('Junk', '/items.htm#junk', '');
addItem('Materials', '/items.htm#materials', '');
addItem('Mounts', '/items.htm#mounts', '');
addItem('Potions', '/items.htm#potions', '');
addItem('Valuables', '/items.htm#valuables', '');

startMenu('mScrolls', true, 98, 0, 85, subBlank);
addItem('Mundane', '/scrolls.htm#mundane', '');
addItem('Fighter', '/scrolls.htm#fighter', '');
addItem('Apprentice', '/scrolls.htm#apprentice', '');
addItem('Neophyte', '/scrolls.htm#neophyte', '');
...
addDropShadow(pMenu, window.subM,
 [40,"#000000",6,6,-4,-4], [40,"#333333",4,4,0,0]);
